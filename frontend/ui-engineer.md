...
> **Attribution:** Original agent by [@hesreallyhim](https://github.com/hesreallyhim) from [a-list-of-claude-code-agents](https://github.com/hesreallyhim/a-list-of-claude-code-agents)
